...
* **پنج تکنیک تزریق** - classic، dynamic code evaluation، time-based، file-based (به همراه گونه tempfile-based برای هدف‌هایی با محدودیت نوشتن) و out-of-band (OAST) روی HTTP/S و DNS.
