...
* **Πέντε τεχνικές εισαγωγής** - classic, dynamic code evaluation, time-based, file-based (με παραλλαγή tempfile-based για στόχους με περιορισμένη εγγραφή) και out-of-band (OAST) μέσω HTTP/S και DNS.
